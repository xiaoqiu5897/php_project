...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('views/login/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form action="index.php?mod=login&act=isLogin" method="POST"  class="login100-form validate-form flex-sb flex-w">
					...
					<a href="#" class="btn-google m-b-20"><img src="views/login/images/icons/icon-google.png" alt="GOOGLE">Google</a>
